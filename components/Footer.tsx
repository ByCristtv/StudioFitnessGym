    ...
    <footer className='bg-black pt-24'>
      <div className='container mx-auto pb-24'>
        <motion.div
          ...
          className='text-white grid grid-cols-1 xl:grid-cols-4 md:grid-cols-2 gap-x-8 gap-y-12'
        >
          {/* info */}
          <motion.div variants={footerItem} className='flex flex-col gap-4'>
            ...
            <ul className='flex flex-col gap-4'>
              <li className='flex items-center gap-4'>
                ...
                <span>Costa Rica, Pococi, Cariari</span>
              </li>
              <li className='flex items-center gap-4'>
                <FaPhoneAlt className='text-xl text-accent' />
                <span>(506) 2767-8896</span>
              </li>
              <li>
          ...
          {/* newsletter */}
          <motion.div variants={footerItem}>
            <h4 className='h4 text-accent mb-4'>Cartas</h4>
            <div className='flex flex-col gap-4'>
              ...
              <form className='flex items-center'>
                <input
                  ...
                  className='h-[50px] outline-none px-4 text-primary-300 border border-100'
                />
      ...
      <div className='text-white border-t border-white/20 py-12'>
        <div className='container mx-auto h-full'>
          <div className='flex items-center justify-between h-full'>
            <span>&copy; Copyright 2024 CristianJSolutions</span>
