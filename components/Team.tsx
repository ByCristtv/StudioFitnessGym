   ...
   <section className='py-12 xl:h-[110vh]' id='team'>
      <div className='container mx-auto h-full flex flex-col items-center justify-center'>
        <motion.h2
          ...
          className='h2 text-center mb-6 text-[#000000]'
        >
        ...
        >
          {trainerData.map((trainer, index) => {
            return (
              ...
              >
                {/* image */}
                <div className='relative w-[320px] h-[360px] mx-auto mb-4 border-3 rounded-2xl'>
                  <Image src={trainer.image} fill alt='' className='rounded-2xl'/>
                </div>
                {/* name */}
